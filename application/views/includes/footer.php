...
<div class="footer-v9 text-center">
	<div class="container">
		...
		<ul class="footer-v9-menu list-inline">
			<li class="page-scroll"><a href="<?php echo base_url();?>#About">About</a></li>
			<li class="page-scroll"><a href="<?php echo base_url();?>#WhyWe">Why We</a></li>
			<li class="page-scroll"><a href="<?php echo base_url();?>#Services">Services</a></li>
			<li class="page-scroll"><a href="<?php echo base_url();?>#WorkProcess">Work Process</a></li>
			<li class="page-scroll"><a href="<?php echo base_url();?>#Skills">Skills</a></li>
			<li class="page-scroll"><a href="<?php echo base_url();?>#Team">Team</a></li>
			<li class="page-scroll"><a href="<?php echo base_url();?>#Testimonials">Testimonials</a></li>
