<?php include('includes/header.php');?>
	...
	<div class="promo">
				...
				<!-- START REVOLUTION SLIDER 5.0.7 fullscreen mode -->
					<div id="rev_slider_104_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.0.7">
						<ul>	<!-- SLIDE  -->
							<li data-index="rs-309" data-transition="slideoverhorizontal" data-slotamount="default"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="1000"  data-thumb="Agency/assets/plugins/revolution-slider/assets/images/bigbold_3-100x50.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Unify Agency" data-description="">
								<!-- MAIN IMAGE -->
								<img src="<?php echo base_url();?>Agency/assets/plugins/revolution-slider/assets/images/bigbold_3.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
								<!-- LAYERS -->
						...
						Website Highlights &amp; Multi-Media Content.
							...
							<!-- SLIDE  -->
							<li data-index="rs-310" data-transition="slideoverhorizontal" data-slotamount="default"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="1000"  data-thumb="Agency/assets/plugins/revolution-slider/assets/images/typing_cover-100x50.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="HTML5 Video" data-description="">
								<!-- MAIN IMAGE -->
								<img src="<?php echo base_url();?>Agency/assets/plugins/revolution-slider/assets/images/typing_cover.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
								<!-- LAYERS -->
								...
								<div class="rs-background-video-layer"
									...
									data-videomp4="Agency/assets/plugins/revolution-slider/assets/videos/typing.mp4"
							...
							<!-- SLIDE  -->
							<li data-index="rs-311" data-transition="slideoverhorizontal" data-slotamount="default"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="1000"  data-thumb="Agency/assets/plugins/revolution-slider/assets/images/bigbold_1-100x50.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Scroll Down" data-description="">
								<!-- MAIN IMAGE -->
								<img src="<?php echo base_url();?>Agency/assets/plugins/revolution-slider/assets/images/bigbold_1.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
								<!-- LAYERS -->
	...
	<div class="chess-about-us equal-height-columns clearfix" id="About">
		...
		<img src="<?php echo base_url();?>Agency/assets/img-temp/team2.jpg" alt="">
	</div>
	<!-- End About Us Block -->
        ...
        <div class="sorting-block">
            ...
            <ul class="row sorting-grid">
                <li class="col-md-3 col-sm-6 col-xs-12 mix category_1 category_3" data-cat="1">
                    <a href="#">
                        <img class="img-responsive" src="<?php echo base_url();?>assets/img/main/img11.jpg" alt="">
                ...
                <li class="col-md-3 col-sm-6 col-xs-12 mix category_2 category_1" data-cat="2">
                    <a href="#">
                        <img class="img-responsive" src="<?php echo base_url();?>assets/img/main/img13.jpg" alt="">
                        <span class="sorting-cover">
                            <span>Happy New Year</span>
                            <p>Anim pariatur cliche reprehenderit</p>
                        </span>
                ...
                <li class="col-md-3 col-sm-6 col-xs-12 mix category_2 category_3  category_4" data-cat="2">
                    <a href="#">
                        <img class="img-responsive" src="<?php echo base_url();?>assets/img/main/img8.jpg" alt="">
                        <span class="sorting-cover">
                            <span>Happy New Year</span>
                            <p>Anim pariatur cliche reprehenderit</p>
                        </span>
			...
			<div class="row text-left">
				<div class="col-sm-3">
				  ...
				  <ul class="nav nav-tabs nav-stacked g-mb-30" role="tablist">
				    <li role="presentation" class="active"><a href="<?php echo base_url();?>#tab1" aria-controls="tab1" role="tab" data-toggle="tab">User Interfase</a></li>
				    <li role="presentation"><a href="<?php echo base_url();?>#tab2" aria-controls="tab2" role="tab" data-toggle="tab">Identity And Branding</a></li>
				    <li role="presentation"><a href="<?php echo base_url();?>#tab3" aria-controls="tab3" role="tab" data-toggle="tab">Web Design</a></li>
				  </ul>
			  </div>
				...
				<div class="col-sm-9">
				  ...
				  <div class="tab-content">
				    <div role="tabpanel" class="tab-pane fade in active" id="tab1">
				    	<p class="g-mb-30"><img src=<?php echo base_url();?>Agency/assets/img-temp/process/2.jpg" alt="" class="img-responsive"></p>
				    	<div class="row">
				    ...
				    <div role="tabpanel" class="tab-pane fade" id="tab2">
				    	<p class="g-mb-30"><img src="<?php echo base_url();?>assets/img-temp/process/3.jpg" alt="" class="img-responsive"></p>
				    	<div class="row">
				    ...
				    <div role="tabpanel" class="tab-pane fade" id="tab3">
				    	<p class="g-mb-30"><img src="<?php echo base_url();?>Agency/assets/img-temp/process/1.jpg" alt="" class="img-responsive"></p>
				...
				<div class="col-md-3 col-sm-6 col-xs-6 col-2xs-12">
					<div class="our-team-v4-member g-mb-50">
						<div class="our-team-v4-member-wrapper g-mb-40">
							<img src="<?php echo base_url();?>Agency/assets/img-temp/team/2.jpg" alt="">
							<div>
								<em>
  ...
  <!-- END Join Our Team -->
	...
	<div class="testimonials-clients clearfix" id="Testimonials">
        ...
        <ul class="owl-clients-v5">
          <li><a href="<?php echo base_url();?>#"><img src="Agency/assets/img-temp/clients/1.png" alt=""></a></li>
          <li><a href="<?php echo base_url();?>#"><img src="Agency/assets/img-temp/clients/2.png" alt=""></a></li>
          <li><a href="<?php echo base_url();?>#"><img src="Agency/assets/img-temp/clients/3.png" alt=""></a></li>
          <li><a href="<?php echo base_url();?>#"><img src="Agency/assets/img-temp/clients/4.png" alt=""></a></li>
          <li><a href="<?php echo base_url();?>#"><img src="Agency/assets/img-temp/clients/5.png" alt=""></a></li>
          <li><a href="<?php echo base_url();?>#"><img src="Agency/assets/img-temp/clients/6.png" alt=""></a></li>
        </ul>
			</div>
		</div>
	</div>
  	...
  	<div class="container g-pt-80 g-pb-30">
		...
		<div class="row">
  		...
  		<div class="col-sm-3 contacts-v4-info contacts-v4-info--dark equal-height-column">
  			...
  			<div>
					<em>Email</em>
					<strong><a href="<?php echo base_url();?>mailto:info@htmlstream.com">info@htmlstream.com</a></strong>
				</div>
  		</div>
  		<div class="col-sm-3 contacts-v4-info equal-height-column">
