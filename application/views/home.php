...
<?php endif; ?>
	...
	<div class="promo" id="rev_slider_104_1_wrapper" class="rev_slider_wrapper fullscreen-container" data-alias="scroll-effect76" style="background-color:#111111;padding:0px; height:700px; width:100%">
		...
		<!-- Content -->
			<div class="carousel-inner rev_slider fullscreenbanner"  role="listbox">

			<!-- Slide 1 -->
				<div class="item active" data-index="rs-310" data-transition="slideoverhorizontal" data-slotamount="default" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut"
						 ...
						 data-saveperformance="off" data-title="Great Consultancy" data-description="" style="height:700px;">
					<img src="<?php echo base_url();?>asset1/plugins/revolution-slider/assets/images/bigbold_3.jpg"  alt="Sunset over beach"  data-bgposition="center center" data-bgfit="cover"
							 data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina  style="height:700px; width:100%">
							 <div class="carousel-caption" style="text-align:left !important">
						<h3 class=" wow fadeInUpBig" data-wow-offset="20" data-wow-duration="1.75s">Rob Roy Glacier</h3>
						<p  class="wow fadeInUp" data-wow-offset="20" data-wow-duration="2.75s">You can almost touch it!</p>
					</div>
				</div>

			<!-- Slide 2 -->
				<div class="item "data-index="rs-310" data-transition="slideoverhorizontal" data-slotamount="default" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut"
						 data-masterspeed="1000"  data-start="700" data-basealign="slide" data-thumb="<?php echo base_url();?>asset1/plugins/revolution-slider/assets/images/typing_cover-100x50.jpg" data-rotate="0"
						 data-saveperformance="off" data-title="Great Consultancy" data-description="" style="height:700px;">
					<img src="<?php echo base_url();?>asset1/plugins/revolution-slider/assets/images/bigbold_1.jpg"  alt="Sunset over beach"  data-bgposition="center center" data-bgfit="cover"
							 data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina  style="height:700px; width:100%">
			...
			<!-- Slide 3 -->
				<div class="item"  data-index="rs-310" data-transition="slideoverhorizontal" data-slotamount="default" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut"
						 data-masterspeed="1000"  data-start="700" data-basealign="slide" data-thumb="<?php echo base_url();?>asset1/plugins/revolution-slider/assets/images/typing_cover-100x50.jpg" data-rotate="0"
						 data-saveperformance="off" data-title="Great Consultancy" data-description="" style="height:700px;">
					<img src="<?php echo base_url();?>asset1/plugins/revolution-slider/assets/images/typing_cover.jpg"  alt="Sunset over beach"  data-bgposition="center center" data-bgfit="cover"
							 data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina  style="height:700px; width:100%">
